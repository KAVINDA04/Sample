                ...
                <form action="{{route('user.store')}}" method="POST">
                    ...
                    <div class="col-sm-12">
                        <div class="left">
                            ...
                            <input id="firstName" type="text" name="firstName" class=" form-control effect" placeholder="Roy...">
                            <p style="color: red">@error('firstName') {{$message}} @enderror</p>
                        </div>
                        <div class="left">
                            <label for="lastName" class="label">Last Name</label>
                            <input id="lastName" type="text" name="lastName" class="form-control effect" placeholder="Pearson...">
                            <p style="color: red">@error('lastName') {{$message}} @enderror</p>
                        </div>
                        <div class="left">
                            <label for="mobile" class="label">Mobile</label>
                            <input id="mobile" type="text" name="mobile" class="form-control effect" placeholder="0704467943">
